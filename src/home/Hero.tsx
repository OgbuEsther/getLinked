...
const Hero = () => {
  ...
  <div className="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col w-[100%] bg-[#150E28] text-white">
            <div className="w-[100%] max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl">
